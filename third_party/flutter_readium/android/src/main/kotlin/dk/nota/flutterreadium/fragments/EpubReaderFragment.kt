...
class EpubReaderFragment :
    ...
    interface Listener {
        ...
        fun onTextInteraction(json: String, resourceHref: String) {}
        ...
        val navigatorConfig =
            EpubNavigatorFragment
                .Configuration(
                    ...
                    registerJavascriptInterface("flutterReadiumText") { link ->
                        EpubTextInteractionBridge { json ->
                            lifecycleScope.launch {
                                if (isAdded) listener?.onTextInteraction(json, link.href.toString())
                            }
                        }
                    }
                }
