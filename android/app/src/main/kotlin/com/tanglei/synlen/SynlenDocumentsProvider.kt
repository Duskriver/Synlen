    ...
    override fun queryDocument(documentId: String?, projection: Array<out String>?): Cursor {
        ...
        if (documentId == ROOT_ID) {
            ...
            result.newRow().apply {
                ...
                add(DocumentsContract.Document.COLUMN_DISPLAY_NAME, "词镜书库")
