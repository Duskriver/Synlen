...
- **[数据与隐私](../../../../docs/user/privacy.md)**：按"留在设备 / 离开设备"两张表披露数据流向，并说明账户、遥测、崩溃上报与备份的边界。外部服务变化时同批更新此页；单词发音来源的决策见[词卡反馈与直连发音](../bug-fix/2026-09-20-word-popover-feedback-and-pronunciation.md)。
